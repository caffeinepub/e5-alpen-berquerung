...
import type { StagePhoto as _StagePhoto, UserRole as _UserRole, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deleteStagePhoto(arg0: string): Promise<{
        __kind__: "ok";
        ok: null;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.deleteStagePhoto(arg0);
    ...
    async getStagePhotos(arg0: bigint): Promise<Array<StagePhoto>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStagePhotos(arg0);
    ...
    async uploadStagePhoto(arg0: bigint, arg1: string, arg2: string, arg3: number | null): Promise<{
        __kind__: "ok";
        ok: StagePhoto;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.uploadStagePhoto(arg0, arg1, arg2, to_candid_opt_n17(this._uploadFile, this._downloadFile, arg3));
...
function from_candid_StagePhoto_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _StagePhoto): StagePhoto {
...
function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        distanceKm: record_opt_to_undefined(from_candid_opt_n16(_uploadFile, _downloadFile, value.distanceKm)),
...
function from_candid_variant_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "ok" in value ? {
        __kind__: "ok",
        ok: from_candid_StagePhoto_n14(_uploadFile, _downloadFile, value.ok)
    } : "err" in value ? {
        __kind__: "err",
        err: value.err
    } : value;
}
function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_StagePhoto>): Array<StagePhoto> {
    return value.map((x)=>from_candid_StagePhoto_n14(_uploadFile, _downloadFile, x));
}
